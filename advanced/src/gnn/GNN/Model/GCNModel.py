import torch
from torch_geometric.nn import GCNConv, dense_mincut_pool, DMoNPooling, MLP, dense_diff_pool,DenseGCNConv, BatchNorm, GraphNorm, LayerNorm
...
class GCN_Net(torch.nn.Module):
    def __init__(self, 
        ...
        for _ in range(num_layers_pre):
            self.conv_layers_pre.append(GCNConv(hidden_dim, hidden_dim))
        ...
        for _ in range(num_layers_post):
            self.conv_layers_post.append(DenseGCNConv(hidden_dim, hidden_dim))
