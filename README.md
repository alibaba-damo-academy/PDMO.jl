...
This branch contains the implementation and experiments for
*[Automating Reformulation for Parallel ADMM](https://arxiv.org/abs/2603.19417)*
by Sun et al. (2026).
...
invoked as substitutes for the reviewer commands.

Quick parser and regression checks can be run from the repository root with:
